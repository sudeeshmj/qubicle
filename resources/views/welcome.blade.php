...
<body class="antialiased bg-gray-100 dark:bg-gray-900">
    <div class="min-h-screen">
        ...
        @if (Route::has('login'))
            <div class="fixed top-0 right-0 p-6 z-10 text-right">
                @auth
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
            ...
            {{-- Blog Section --}}
            <h1 class="text-center" style="font-size: 20px">Latest Published Blogs</h1>
            ...
            <div class="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
                ...
                ">
                            ...
                            <div class="text-sm text-gray-500 dark:text-gray-400 mt-auto">
                                Posted by <strong>{{ $post->author->name ?? 'Unknown' }}</strong><br>
                                <span class="text-xs">{{ $post->created_at->format('M d, Y') }}</span>
                            </div>
                        </div>
                    </a>
                @empty
